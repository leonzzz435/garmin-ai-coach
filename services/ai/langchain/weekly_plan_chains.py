...
class WeeklyPlanChains:
    ...
    def create_season_planner_chain(self):
        ...
        return (season_planner_prompt | llm | StrOutputParser()).with_config(
            {"run_name": f"season_planner_{self.execution_id}"}
        )
    ...
    def create_weekly_planner_chain(self):
        ...
        return (weekly_planner_prompt | llm | StrOutputParser()).with_config(
            {"run_name": f"weekly_planner_{self.execution_id}"}
        )
    ...
    def create_weekly_plan_formatter_chain(self):
        ...
        return (formatter_prompt | llm | StrOutputParser()).with_config(
            {"run_name": f"weekly_plan_formatter_{self.execution_id}"}
        )
